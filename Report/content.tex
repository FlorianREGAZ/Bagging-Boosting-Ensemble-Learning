...
% TODO: say when to pick which model. Example:
% The choice between bagging and boosting (and their advanced versions) should be guided by the specific requirements of the problem at hand, considering factors like data size, feature relationships, and the inherent trade-offs between bias and variance.
