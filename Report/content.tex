...
% ---------------------------------------------------------------------------- %
\subsection{Boosting}
% TODO: mention that boosting is typically using stumpts with Decision trees
...
% Difference to normal boosting:
% - different learning algorithm
% - all trees have the same weight, resulting in an equal contribution to the final prediction
% - TODO: advantages/ disadvantages of gradient boosting vs boosting
% ---------------------------------------------------------------------------- %
\section{Examples}
