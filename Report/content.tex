...
% TODO: maybe remove or reforulate the last sentence -> that there are many other Ensemble learning techniques
% ---------------------------------------------------------------------------- %
\subsection{Bagging}
...
\begin{figure}[htbp]
    ...
    \makebox[\textwidth]{\includegraphics[width=1.25\textwidth]{figures/examples/bcw_comparison}}
    \caption{
...
\begin{figure}[htbp]
    ...
    \makebox[\textwidth]{\includegraphics[width=1.25\textwidth]{figures/examples/hdc_comparison}}
    \caption{
...
% - Every ensemble performed significantly better than the decision tree from 5% up to 13%
% - bagging and random forest had the same amount of estimators where they performed best, however random forest outperformed bagging with being nearly 4% more accurate
% - overall adaboost had the highest accuracy on the validation set, eventhough it performed worst on the folds on average. Also adaboost had the least estimators and still performed best.
% - overall figure 6 shows that the performance relative to the estimator count is much more volatile than in example 1. However which stays the same is that most improvements are made within the first 50 estimators. Additionally whats interesting to see is that accuracy of adaboosting is going down with more estimators as it is overfitting the training data.    
...
% TODO: add general conclusion of the examples and what was seen and what was expected to be seen
