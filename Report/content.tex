...
%- wisdom of crowds -> ensemble methods use multiple smaller learning algorithms
%  that work well at different parts of the problem and can solve the full problem by combining them.
%  Resulting in predicitve performance better than the used learning algorithm alone.
%- Evaluating the predictions and training the ensemble requires more computational power and storage.
%- Popular ensembles like bagging and boosting, which we will focus on, but there are also others like stacking or blending.
%
% TODO: Insert image of prediction
